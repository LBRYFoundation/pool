...
' | sudo -E tee /etc/nginx/blockuseragents.rules >/dev/null 2>&1
    ...
    cd ~
    git clone https://github.com/lbryio/pool.git
...
output "Adding Start Screen file to ~/"
echo '
#!/bin/bash
LOG_DIR=/var/log
WEB_DIR=/var/web
...
sudo mv $HOME/yiimp/ $HOME/lbry-pool-install
sudo service nginx restart
sudo service php7.0-fpm reload
...
output ""
output "Thank you for installing the Lbry Pool"
